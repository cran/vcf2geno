...
/**
 * Read @param, for eacho variant in @param range, put each location to @param location under the key @param gene
...
SEXP impl_rvMetaReadData(SEXP arg_pvalFile, SEXP arg_covFile, SEXP arg_geneFile, SEXP arg_gene) {
  int numAllocated = 0;
  SEXP ret = R_NilValue;
